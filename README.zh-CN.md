...
| 调查引擎 | 基础已实现 | 持久调查事实、严格 mTLS READ Task Gateway、原子 connector/target/egress/executor Bundle、固定 READ executor/Activity、恢复优先 Temporal v2、immutable Snapshot 与角色隔离的 Temporal Starter/Control Worker；尚无 live Runner/Outbox/Temporal 进程装配，非配置化 Admission 在 M5C2-4c 与外部 Go/No-Go 前保持关闭 |
