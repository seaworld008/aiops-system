...
| 调查引擎 | 基础已实现 | 持久调查事实、严格 mTLS READ Task Gateway、原子 connector/target/egress/executor Bundle、独立 READ-only client，以及固定 Prometheus/VictoriaLogs executor；尚无 live Runner/Temporal 装配，非配置化 Admission 在 M5C2-4b/4c 门禁前保持关闭 |
