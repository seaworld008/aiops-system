...
test-integration:
	...
	go test -race -count=1 ./internal/store/postgres ./internal/execution/postgres ./internal/investigation/postgres ./internal/runneridentity/postgres ./internal/readtask/postgres
