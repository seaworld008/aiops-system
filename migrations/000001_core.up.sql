...
CREATE TABLE signals (
	...
	payload_hash text NOT NULL CHECK (octet_length(payload_hash) BETWEEN 1 AND 128),
	fingerprint text NOT NULL CHECK (octet_length(fingerprint) BETWEEN 1 AND 512),
