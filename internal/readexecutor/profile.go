...
const (
	...
	CurrentProfileDigest = "caca609e396ad0c3af30dba58759d889fd31165505ef75978eb73ce8c7f65e32"
...
func currentProfileContractDigest() (string, error) {
	document := struct {
		...
		Transport: profileTransport{
			TLSMinimumVersion: "1.3", HTTPVersion: "1.1",
		...
		EvidenceProjection: "read-connector-validator.v1",
