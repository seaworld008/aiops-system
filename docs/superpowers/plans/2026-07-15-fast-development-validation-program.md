...
4. M1B 保留复合 Source Scope、完整 authority-set 子集授权、restricted-empty、MANUAL 单 Environment usage、稳定 keyset/QueryDigest、safe columns 与 Secret/checkpoint/fence 排除；M1C 保留 closed sum type、XOR、typed-nil/alias 拒绝、checkpoint/事实不可序列化泄漏与输入上限/secret-shaped negative；
