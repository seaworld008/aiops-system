...
[PR #153](https://github.com/seaworld008/aiops-system/pull/153) pre-A2a formal-fixture compatibility exact9 已从 parent `d8d632f453929fbe056dc499a6d64144d83011bf` squash merge为 `main@c0b620e6fff9de0b746504f5fb7231fcb4a213c4`，tree为`0af13374448f1386593291631e10a07add41440b`，精确九文件、`+433/-45`。它只冻结 exact3 columns、closure trigger 与 down drop 的baseline/formal双完整状态、可逆复用与auxiliary matrix，不实现migration/A2a或任何能力。其后fresh formal A2a确认Pack06唯一identity FK无论以inline named constraint或top-level`ALTER TABLE ... ADD CONSTRAINT`表达，都会分别被merged extractor/discriminator报为`unreviewed gate-evidence table element`/`unreviewed gate-evidence ALTER`；该partial A2a与停止的`cb00`均为`STOPPED/NOT PASS`且永不作为输入。
