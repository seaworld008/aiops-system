...
- READ target/egress manifest、runtime Bundle、固定 HTTP executor 与 M5C2-4b Temporal v2 已完成本地契约验证，但尚未
  进程装配；M5C2-4c 的 digest/PKI/network/E2E 门禁前，关闭态 Admission 会同时阻断 READ claims
