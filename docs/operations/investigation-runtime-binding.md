...
5. 保持关闭态 Admission，先验证查询、create/replay、未绑定 Task 拒绝和数据库告警；C2-4a Bundle 与 C2-4b Temporal v2 已完成未装配契约，但 C2-4c assembly 及外部 PKI/network/E2E 门禁完成前不得开启 claim。
